...
def get_servers():
    ...
    cols = ['id', 'ipAddress', 'country', 'region', 'opscodeBranch', 'description', 
            'provider', 'puppetLastRun', 'status']
    
    g = [(a,b,c,d,e,f,g,h,i) for a,b,c,d,e,f,g,h,i 
         in zip(r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],r[8])]
    
    records = [{cols[0]: r[0],cols[1]: r[1],cols[2]: r[2],cols[3]: r[3],cols[4]: r[4],
        cols[5]: r[5],cols[6]: r[6],cols[7]: r[7],cols[8]: r[8]}
         for r in g]
    return records
